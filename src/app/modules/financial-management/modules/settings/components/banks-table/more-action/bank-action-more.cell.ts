...
export class BankMoreActionsCell extends CoreBaseComponent implements ICellRendererAngularComp {
  ...
  deleteBank() {
    this._bankService
      .deleteBank(this.params.data.id)
