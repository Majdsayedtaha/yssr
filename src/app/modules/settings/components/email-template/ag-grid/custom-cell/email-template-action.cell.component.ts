...
export class EmailTemplateActionCellComponent extends CoreBaseComponent implements ICellRendererAngularComp {
  ...
  deleteRow() {
    this._templateService.deleteEmailTemplate(this.cell.data.id).subscribe(res => {
  ...
  edit() {
    this._matDialog
      .openDialog(DialogEmailTemplateFormComponent, {
        data: {
